...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/https:/github.com/ryan-biostat/ryan-biostat.github.io/tree/main/assets/pdf/RG_CV_11082025.pdf";
          },
        },{id: "nav-teaching",
          title: "teaching",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%67%61%6C%6C%61%67%68%65%72@%6D%63%77.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ryan-biostat", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ryan-gallagher-29b4921b8", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0008-3852-9715", "_blank");
        },
      },{
      id: 'light-theme',
