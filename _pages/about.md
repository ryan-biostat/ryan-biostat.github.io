...
profile:
  ...
  more_info: >
    <div class="text-center">
      ...
      <p class="h5">Advanced Genomics Lab</p>
      <p class="h5">Medical College of Wisconsin</p>
    </div>
...
My research interests center on discovering rare, disease-causing variants through modern statistical and computational techniques. The growing availability of high-quality sequencing data from long-read sequencing (LRS) and optical genome mapping (OGM) will enable more accurate disease–variant associations and ultimately support improved clinical decision-making. 
